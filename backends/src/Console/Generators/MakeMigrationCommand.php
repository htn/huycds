...
class MakeMigrationCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:backend:migration
     ...
     * @var string
     */
    protected $description = 'Create a new backend migration file';
    ...
    public function handle()
    {
        ...
        $options['--path'] = str_replace(realpath(base_path()), '', realpath(backend_path($this->argument('slug'), 'Database/Migrations')));
