...
class MakeModelCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:backend:model
     ...
     * @var string
     */
    protected $description = 'Create a new backend model class';
    ...
    public function handle()
    {
        if (parent::handle() !== false) {
            if ($this->option('migration')) {
                ...
                $this->call('make:backend:migration', [
    ...
    {
        return backend_class($this->argument('slug'), 'Models');
    }
}
