...
class MakeProviderCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:backend:provider
     ...
     * @var string
     */
    protected $description = 'Create a new backend service provider class';
     ...
     * @var string
     */
    protected $type = 'Backend service provider';
    ...
    {
        return backend_class($this->argument('slug'), 'Providers');
    }
}
